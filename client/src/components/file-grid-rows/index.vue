<template>
  <div class="FileGridRows">
    <div class="FileGridRows-Columns">
      <div v-for="(item, rowIndex) in rows" :key="rowIndex">
        {{ item }}
      </div>
    </div>
    <div class="FileGridRows-Files">
      <div v-for="(item, fileIndex) in files" :key="fileIndex" class="FileGridRows-Elem">
        <div
        ...
        >
          <div v-if="key === 'folder'" class="FileGridRows-Folder">
          ...
          <router-link v-if="key === 'commit'" :to="{ path: `/commit/${value}` }">
            {{ value }}
          </router-link>
          <div v-else>
            {{ value }}
