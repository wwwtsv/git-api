      ...
      <div v-if="rows.length">
        ...
        >
          <div
            ...
            :class="{ 'BaseTable-Item_file': listType === 'file' }"
          >
            <div v-if="key === 'folder'" class="BaseTable-Icon">
            ...
            <div v-else-if="value.match(/readme/gi)" class="BaseTable-Icon">
            ...
            <div v-else-if="key === 'file'" class="BaseTable-Icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="10" height="13" viewBox="0 0 10 13" fill="none">
                <path
            ...
            <div v-else class="BaseTable-Text" :class="{ 'BaseTable-Text_committer': key === 'committer' }">
              {{ value }}
            </div>
          </div>
        </div>
...
.BaseTable {
  ...
  &-Elem {
    ...
    &:hover {
      background-color: rgba(#7f8285, 0.2);
    }
  }
  &-Item {
    &_folder {
