  ...
  <div class="ContentTableRowsMobile">
    <div v-if="!loadingMarker && rows.length">
      ...
      >
        ...
        >
          <div v-if="key === 'folder'" class="ContentTableRowsMobile-Folder">
            <div class="ContentTableRowsMobile-Icon">
            ...
            <router-link class="ContentTableRowsMobile-Link_folder" :to="{ path: `${route.fullPath}/${value}` }">
              {{ value }}
            </router-link>
          </div>
          ...
          <div v-else-if="key === 'file'">
            ...
            <div v-if="value.match(/readme/gi)" class="ContentTableRowsMobile-Icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="10" height="13" viewBox="0 0 10 13" fill="none">
                <path
            ...
            <router-link
              class="ContentTableRowsMobile-Link_file"
              :to="{
          ...
          <router-link
            v-else-if="key === 'hash'"
            class="ContentTableRowsMobile-Link_commit"
          ...
          <div
            v-else
            class="ContentTableRowsMobile-Text"
            :class="{ 'ContentTableRowsMobile-Text_committer': key === 'committer' }"
          >
            {{ value }}
          </div>
        </div>
